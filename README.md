...
| :-----------------------------------------------------------------------: | :----------------------------------------------------- | :--------------- | :------------------------------------------------------------------------------------------------------------------------------ |
| <img src="https://github.com/Evgeniy-sub8way.png" width="50" height="50"> | [Yevhenii Priadko]([https://github.com/Evgeniy-sub8way](https://github.com/yevhenii-priadko)) | **Team Lead**    | **Hero Section:** Project architecture, Vite build configuration, development of the main hero section, and coordination of technical decisions.     |
